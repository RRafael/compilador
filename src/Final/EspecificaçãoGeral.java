...
public class EspecificaçãoGeral {
    ...
    public static void identificadores_PalavrasReservadas(String texto) {
        ...
        if (estadoAtual == q2 || estadoAtual == q5 || estadoAtual == q6 || estadoAtual == q8 || estadoAtual == q1 || estadoAtual == q3) {
        ...
        for (int j = 0; j < lexema.length(); j++) {
            switch (estadoAtual) {
                ...
                case q3:
                    if (lexema.charAt(j) == '/') {
                        estadoAtual = q4;
                    } else if (Character.isDefined(lexema.charAt(j))) {
                        estadoAtual = q3;
                    } else {
                        estadoAtual = -1;
                    }
